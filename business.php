            ...
            <thead id=\"businessheading\">
                <tr>
                    ...
                    if($avgrating==0){
                        ...
                        echo "<th><h5 id=\"rating\"><b>Average User Rating: </b></h5></th>";
                        echo "<th><h4 id=\"numrating\">".number_format($avgrating,1)."/10</h4></th>";
                    }
               echo" </tr>
            </thead>
        </table>
        ...
        */
        echo"<div align='center'>
          ...
          <div class=\"panel-heading\">
            <h2 class=\"panel-title\" align=\"left\"><b>".$biz_info['name']."</b></h2>
            <h3 class=\"panel-title\" align=\"right\">";if($avgrating==0){
                        //echo "<th><h5 id=\"rating\">No ratings. Be the first to rate this business.</h5></th>";
                    }
                    else{
                        echo "<b>Average User Rating:   ".number_format($avgrating,1)."/10 </b>";
                    }
          echo"</div>
          <div class=\"panel-body\">
            <table border=\"0\" cellpadding=\"5\" width=\"1100\">
                <tbody>
                    <tr>
                        <td><a href=\"gallery.php?biz_id=".$biz_info['biz_id']."\"><img src=".$biz_info['img']." alt=\"\" width=150 height=\"150\"></a></td>
                            <td id=\"businessdetails\">
                                <ul style=\"list-style: none;\">
                                <h5><b>Address:</b></h5>
                                <li>".$biz_info['street']."</li>
