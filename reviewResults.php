        ...
        <div class="container ">   
            ...
            <div align="center">
                <div align="center">
                    ...
                    <ul class="pagination">
                        ...
                        if ($start - $max_results >= 0) {
                            print "<li><a href=\"reviewResults.php?start=" . ($start - $max_results) . "&search=" . $search . "&type=" . $type . "&items=" . $max_results . "\">Prev</a></li>";
                        }
                        if ($total_rows > $max_results) {
                            for ($j = 0; $j < $button_count; $j++) {
                                if ($j != ($start / $max_results)) {
                                    print"<li><a href=\"reviewResults.php?start=" . ($j * $max_results) . "&search=" . $search . "&type=" . $type . "&items=" . $max_results . "\"><u>" . ($j + 1) . "</u></a></li>";
                                } else {
                                    print"<li><a href=\"reviewResults.php?start=" . ($j * $max_results) . "&search=" . $search . "&type=" . $type . "&items=" . $max_results . "\"><b>" . ($j + 1) . "</b></a></li>";
                                }
                            }
                        }
                        if ($start + $max_results < $total_rows) {
                            print "<li><a href=\"reviewResults.php?start=" . ($start + $max_results) . "&search=" . $search . "&type=" . $type . "&items=" . $max_results . "\">Next</a></li>";
                        }
                        ?>
                    </ul>
                </div>
                ...
                <h5><-- Showing <?php
                    ...
                    else if ($total_rows > $start + $max_results) {
                    ...
                    <span align="right">    
                        <form method="post" id="items_per_page" action="<?php print "reviewResults.php?start=0&search=" . $search . "&type=" . $type . ""; ?>">Items Per Page:  
            ...
            <div class="col-md-9" id="resultsDiv" align="right">
                            ...
                            <div class="thumbnail padding2">
                                ...
                                <div class="caption">
                                    <div class="padding1">
                                        ...
                                        <?= $biz_results[$i + $start]['phone'] ?><br><br>
                                        </p>
                                        <?php
